...
import 'package:fuiopia/data/models/product_model.dart';
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: product.isAvailable ? const Color(0xFFFFE6E6) : const Color(0xFFF5F6F9),
            shape: BoxShape.circle,
          ),
          child: SvgPicture.asset(
            ICON_CONST.CHECK_MARK,
            color: product.isAvailable ? const Color(0xFFFF4848) : Colors.black26,
          ),
        ),
      ],
    );
