...
import 'package:fuiopia/data/repository/location_repository/location_repo.dart';
...
class AddressPickerBloc extends Bloc<AddressPickerEvent, AddressPickerState> {
  final LocationRepository _locationRepository =
      AppRepository.locationRepository;

  AddressPickerBloc() : super(const AddressPickerState());
